...
export const OBSTACLE_PATTERNS = [
  ...
  gate("opening-gate-top", 0, [0, 1], "generous high opening", ["head", "noodle-man", "tube-woman", "scuba-man"]),
  ...
  gate("two-row-gate-top", 0, [0, 1], "legacy high opening", ["head", "noodle-man", "tube-woman", "scuba-man"]),
